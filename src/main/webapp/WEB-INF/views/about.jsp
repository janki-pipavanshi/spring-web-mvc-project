...
<head>
  ...
  <title>Shija Restaurant - Blog Category Bootstrap Responsive Website Template | About : W3layouts</title>
  ...
  <div class="container">
      <nav class="navbar navbar-expand-lg stroke p-0">
          <h1> <a class="navbar-brand" href="index">
                  <span class="fa fa-bell-o"></span>Shija Restaurant
              </a></h1>
            ...
            <div class="d-grid-2">
                <div class="text2 mt-4">
                    ...
                    <div class="single-post-content-1 row mt-4 no-gutters">
                        <div class="col-md-5">
                            <img src="images/about1.jpg" class="img-fluid radius-image" alt="image">
                        </div>
  ...
  <footer class="py-5">
    <div class="container pt-md-5">
      <div class="footer-logo mb-lg-5 mb-4 text-center">
        <a class="navbar-brand" href="index"><span class="fa fa-bell-o"></span> Shija Restaurant</a>
